...
class Arm:
    def __init__(self):
        try:
            ...
            rospy.wait_for_service("/my_gen3/base/play_joint_trajectory")
            rospy.wait_for_service("/my_gen3/base/play_cartesian_trajectory")
    ...
    def get_ik(self, pose=None, check_collisions=True):
        ...
        compute_ik = rospy.ServiceProxy("/my_gen3/compute_ik", GetPositionIK)
        if pose is None:
    ...
    def get_fk(self, joints=None):
        ...
        compute_fk = rospy.ServiceProxy("/my_gen3/compute_fk", GetPositionFK)
    ...
    def get_joints(self, seven_dof=True):
        """
        Returns current joints as a list in order of joints 1-7
        """
    ...
    def goto_joint_pose(self, joints, radians=False):
        """
    ...
    def joint_velocity_command(self, values, duration, duration_timeout=None, collision_check=False):
        ...
        def velocity_command(values, duration):
            joint_vel_publisher = rospy.Publisher(
                "/my_gen3/in/joint_velocity", Base_JointSpeeds, queue_size=10, latch=True)
            stop_publisher = rospy.Publisher(
                "/my_gen3/in/stop", std_msgs.msg.Empty, queue_size=10, latch=True)
    ...
    def goto_joint_pose_sim(self, joints):
        ...
        go_to_joints = rospy.ServiceProxy(
            "/my_gen3/base/play_joint_trajectory", PlayJointTrajectory)
    ...
    def goto_cartesian_pose_sim(self, pose, speed=.1, duration=None, radians=True):
        ...
        go_to_cart = rospy.ServiceProxy(
            "/my_gen3/base/play_cartesian_trajectory", PlayCartesianTrajectory)
